              ...
              <div className="col-lg-6">
                <div className="shop-content">
                  ...
                  <div className="d-flex align-items-center gap-8 pb-4 border-bottom">
                    ...
                    <a href="javascript:void(0)">({numOfReviews} Reviews)</a>
                  </div>
                        ...
                        <div className="d-flex align-items-center gap-9 mb-3">
                          ...
                          <div className="progress bg-primary-subtle w-100 h-4">
                            <div
                              ...
                              aria-valuemax="100"
                              style={{
                                width: `${reviews?.filter((x) => x.rating === 1)?.length
                                  }%`,
                              }}
                            ></div>
                          </div>
                          <h6 className="mb-0">
                            ({reviews?.filter((x) => x.rating === 1)?.length})
                          </h6>
                        </div>
                        <div className="d-flex align-items-center gap-9 mb-3">
                          ...
                          <div className="progress bg-primary-subtle w-100 h-4">
                            <div
                              ...
                              aria-valuemax="100"
                              style={{
                                width: `${reviews?.filter((x) => x.rating === 2)?.length
                                  }%`,
                              }}
                            ></div>
                          </div>
                          <h6 className="mb-0">
                            ({reviews?.filter((x) => x.rating === 2)?.length})
                          </h6>
                        </div>
                        <div className="d-flex align-items-center gap-9 mb-3">
                          ...
                          <div className="progress bg-primary-subtle w-100 h-4">
                            <div
                              ...
                              aria-valuemax="100"
                              style={{
                                width: `${reviews?.filter((x) => x.rating === 3)?.length
                                  }%`,
                              }}
                            ></div>
                          </div>
                          <h6 className="mb-0">
                            ({reviews?.filter((x) => x.rating === 3)?.length})
                          </h6>
                        </div>
                        <div className="d-flex align-items-center gap-9 mb-3">
                          ...
                          <div className="progress bg-primary-subtle w-100 h-4">
                            <div
                              ...
                              aria-valuemax="100"
                              style={{
                                width: `${reviews?.filter((x) => x.rating === 4)?.length
                                  }%`,
                              }}
                            ></div>
                          </div>
                          <h6 className="mb-0">
                            ({reviews?.filter((x) => x.rating === 4)?.length})
                          </h6>
                        </div>
                        <div className="d-flex align-items-center gap-9">
                          ...
                          <div className="progress bg-primary-subtle w-100 h-4">
                            <div
                              ...
                              aria-valuemax="100"
                              style={{
                                width: `${reviews?.filter((x) => x.rating === 5)?.length
                                  }%`,
                              }}
                            ></div>
                          </div>
